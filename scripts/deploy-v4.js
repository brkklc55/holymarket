...
async function main() {
    console.log('Deploying PredictionMarket v4...');
    ...
    // Update address
    constants = constants.replace(/export const PREDICTION_MARKET_ADDRESS = "0x[a-fA-F0-9]+";/, `export const PREDICTION_MARKET_ADDRESS = "${receipt.contractAddress}";`);

    // Update ABI (optional but good for consistency)
    // Actually, I'll just write the whole ABI part
